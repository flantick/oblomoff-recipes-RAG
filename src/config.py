...
PLAYLIST_INTENTS: list[tuple[str, str]] = [
    (r"сала[тд]", "Салаты"),
    (r"\bсуп\w*|борщ|\bщи\b|солянк", "Супы"),
    (r"ры[бо]\w*|лосос|форел|треск|креветк|кальмар|\bмиди\w*|морепродукт", "Блюда из рыбы и морепродуктов"),
    (r"закуск|намазк|паштет|брускетт", "Закуски"),
    # "кур" alone would also take "куркума" and "курага", hence the explicit stems.
    (r"\bкури\w*|\bкуроч\w*|\bкур\b|индейк|\bутк\w*|птиц", "Блюдо из птицы"),
    (r"стейк|говядин|свинин|баранин|мяс\w*|фарш|котлет", "Блюда из мяса"),
    (r"шашлык|мангал|\bгрил\w*|барбекю|бербекю|на угл\w*|на костре", "Мангал, гриль, бербекю, печь"),
